...
import { IRegister, IUserInfo,  IverifyUser} from '../interface/user.interface';
...
//  566605
export  const  verifyUser = async (payload:  IverifyUser, user: any): Promise<ApiResponseType> => {
  try {
...
//Resend Otp 
export const ResentOtp = async (payload: IUserInfo, user: any) => {
     try {
...
//User Info 
export const UserInfo = async (payload: any, user: any): Promise<ApiResponseType> => {
